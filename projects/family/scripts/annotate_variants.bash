...
${ANNOVAR_TABLE} "${ANNOVAR_INPUT}" \
        ...
        -protocol wgEncodeRegTfbsClusteredV3,tfbsConsSites,wgEncodeRegDnaseClusteredV3,gerp++gt2,RegulomeDB_dbSNP141_Score,refGene,genomicSuperDups,esp6500siv2_all,gnomad_exome,gnomad_genome,dbnsfp33a,cg69,exac03,1000g2015aug_all,clinvar_20170905,avsnp150,cadd13gt10 \
        -operation r,r,r,f,f,g,r,f,f,f,f,f,f,f,f,f,f \
        -remove -nastring . \
        -thread 20 
